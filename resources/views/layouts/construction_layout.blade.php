...
<head>
	...
	<link rel="stylesheet" href="{{ asset('construction/construction.css') }}" type="text/css" />
	<!-- / -->
	...
	<link rel="stylesheet" href="{{ asset('construction/css/fonts.css') }}" type="text/css" />

	<link rel="stylesheet" href="{{ asset('css/responsive.css') }}" type="text/css" />	

    <link rel="stylesheet" href="{{ asset('construction/css/colors.css') }}" type="text/css" />
    
    <meta name="viewport" content="width=device-width, initial-scale=1" />

	<!-- Document Title
    ============================================= -->
    <title>Idmacero | @yield('title')</title>
	...
	<div id="wrapper" class="clearfix">
		...
		<header id="header" class="sticky-style-2">
			...
			<div class="container clearfix">
				...
				============================================= -->
				<div id="logo">
					<a href="index.html" class="standard-logo"><img src="{{ asset('construction/images/logo.png') }}" alt="Canvas Logo"></a>
					<a href="index.html" class="retina-logo"><img src="{{ asset('construction/images/logo@2x.png') }}" alt="Canvas Logo"></a>
				</div><!-- #logo end -->
		...
		<section id="slider" class="slider-element slider-parallax swiper_wrapper clearfix" style="height: 550px;" data-loop="true">
			...
			<div class="swiper-container swiper-parent">
				<div class="swiper-wrapper">
					<div class="swiper-slide" style="background-image: url('{{ asset('construction/images/slider/2.jpg') }}'); background-position: center top;">
						<div class="container clearfix">
